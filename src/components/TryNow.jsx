...
import { Upload, Image, Sparkles, Wand2, Download, Check } from "lucide-react";

const TryNow = () => {
  // Mock removeBg function for demonstration
  const removeBg = (file) => {
      ...
      <div className="relative max-w-7xl mx-auto">
        ...
        <div className="text-center mb-8 sm:mb-12 lg:mb-16">
          ...
          <p className="text-base sm:text-lg lg:text-xl text-gray-600 max-w-2xl mx-auto leading-relaxed">
            Get professional-quality transparent backgrounds for any image with our advanced AI technology. 
            Perfect for e-commerce, design, and creative projects.
          </p>
        </div>
        ...
        <div className="mt-8 sm:mt-12 text-center">
          <p className="text-xs sm:text-sm text-gray-500 max-w-2xl mx-auto leading-relaxed">
            Your privacy is protected. Images are processed securely and automatically deleted after processing. 
            No watermarks for basic use.
          </p>
        </div>
      </div>
    </section>
