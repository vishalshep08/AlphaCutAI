...
const Result = () => {
  ...
  // Simulate loading for result preview
  useEffect(() => {
  ...
  // Handles image download with progress simulation
              ...
              <div className="inline-flex bg-gray-100 rounded-lg p-1">
                <button
                  ...
                  className={`px-4 py-2 rounded-md text-sm font-medium transition-all ${
                    showComparison ? "bg-white text-gray-900 shadow-sm" : "text-gray-600 hover:text-gray-900"
                  }`}
                >
                  Side by Side
                </button>
              ...
              <div className="mt-8 sm:mt-12">
                ...
                <div className="mt-6 text-center">
                  ...
                  <div className="flex flex-wrap justify-center gap-2">
                    {["PNG", "JPG", "WEBP", "High Resolution"].map((format) => (
                      <button
                        key={format}
